...
MODULOS = sistema IUser IRegistros IHostal DataHostalExtendido Hostal Usuario Empleado Huesped Habitacion Reserva ReservaGrupal ReservaIndividual Estadia Calificacion Respuesta DataReserva DataReservaGrupal DataReservaIndividual DataEstadia DataCalificacion DataHostal  DataHabitacion DataUsuario DataHuesped DataEmpleado HostalController UserController RegistrosController DtFechaHora

#MODULOS = sistema IUser IRegistros IHostal HostalController UserController RegistrosController DataUsuario DataHuesped DataEmpleado DataHostal DataHabitacion Habitacion Hostal DtFechaHora
...
CCFLAGS = -Wall -I$(HDIR) -g -fpermissive
...
# casos de prueba
# CASOS = 00 01 02 03 04 05 06 07 200 300 400 500 t-cp t-grafo t-map
CASOS =
